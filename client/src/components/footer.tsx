      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-2">
                  <li><Link href="/documentation" className="text-gray-600 hover:text-primary">Documentation</Link></li>
                  <li><Link href="/tutorials" className="text-gray-600 hover:text-primary">Tutorials</Link></li>
                  <li><Link href="/faq" className="text-gray-600 hover:text-primary">FAQ</Link></li>
                  <li><Link href="/api" className="text-gray-600 hover:text-primary">API Reference</Link></li>
                </ul>
              </div>
              <div>
                <h3 className="text-sm font-semibold text-gray-700 tracking-wider uppercase">Community</h3>
                <ul className="mt-4 space-y-2">
                  <li><Link href="/forums" className="text-gray-600 hover:text-primary">Forums</Link></li>
                  <li><Link href="/events" className="text-gray-600 hover:text-primary">Events</Link></li>
                  <li><Link href="/discord" className="text-gray-600 hover:text-primary">Discord Server</Link></li>
                  <li><Link href="/code-of-conduct" className="text-gray-600 hover:text-primary">Code of Conduct</Link></li>
                </ul>
              </div>
              <div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 flex flex-col items-center">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} ToastSoul Industries. All rights reserved.
          </p>
